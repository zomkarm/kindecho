...
">
    @foreach ($navItems as $item)
        ...
        <a href="{{ route($item['route']) }}"
           class="flex flex-col items-center md:mb-6 rounded-md hover:text-white text-sm transition text-white-600 font-semibold hover:text-white-600 hover:bg-blue-700 p-2">
