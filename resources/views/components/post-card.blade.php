<div class="flex h-full">
    <div class="flex flex-col justify-between h-full w-full bg-white/20 backdrop-blur-md rounded-bl-2xl rounded-tr-2xl shadow-md  p-5 hover:shadow-xl border-2 border-transparent hover:border-bgcol transition-all duration-300 group relative overflow-hidden">
        ...
        <div class="absolute -inset-0.5 bg-gradient-to-tr from-pink-100 to-indigo-100 opacity-0 group-hover:opacity-50 focus:opacity-50 active:opacity-50  transition duration-500 rounded-2xl blur-2xl z-0"></div>
        ...
        <div class="relative z-10">
            ...
            <div class="text-lg font-serif text-white hover:text-gray-800 leading-relaxed line-clamp-5 italic">
                “{{ $post->content }}”
            </div>
        </div>
